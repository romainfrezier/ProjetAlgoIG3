protocol joueurProtocol{
  associatedtype quarto : quartoProtocol
  ...
  // Post : crée une instance de joueurProtocol
  init(nomJoueur : String, currentGame : quarto)
