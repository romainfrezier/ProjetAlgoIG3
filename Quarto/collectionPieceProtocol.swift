...
protocol CollectionPieceProtocol : Sequence{
  associatedtype collectionPieceIterator : IteratorProtocol
  ...
  mutating func addPiece(pieceToAdd: piece) 
  ...
  func makeUnavailable(piece : piece)
  ...
  func getSquare(xStart : Int, yStart : Int, xEnd : Int, yEnd : Int)
